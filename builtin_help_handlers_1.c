#include "header.h"
/**
 * help_all - Displays all possible builtin shellby cmds
 */
void help_all(void)
{
...
/**
 * help_alias - Displays the informations on the shell by builtin command 'alias'
 */
...
/**
 * help_cd - Displays all information on the shell by builtin command 'cd'
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays all information on the shell by builtin command 'exit'
 */
void help_exit(void)
{
...
/**
 * help_help - Displays all information on the shell by builtin command 'help'
 */
void help_help(void)
{
