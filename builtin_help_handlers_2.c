#include "header.h"
/**
 * help_environment - Displays all information on the shell by builtin command 'env'
 */
...
/**
 * help_unsetenv - Displays the informations on the shellby builtin command
 * 'unsetenv'
 */
void help_unsetenvironment(void)
{
